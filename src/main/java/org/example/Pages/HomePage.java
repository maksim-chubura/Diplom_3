...
public class HomePage {
    ...
    private By enterAcountButton = By.xpath("//*[@id=\"root\"]/div/main/section[2]/div/button");
    // локатор "Конструктор"
    ...
    private final By bunsChapter = By.xpath("//*[@id=\"root\"]/div/main/section[1]/div[1]/div[1]/span");
    // локатор раздела Соусы
    private final By saucesChapter = By.xpath("//*[@id=\"root\"]/div/main/section[1]/div[1]/div[2]/span");
    // локатор раздела Ингридиенты
    private final By ingredientsChapter = By.xpath("//*[@id=\"root\"]/div/main/section[1]/div[1]/div[3]/span");
